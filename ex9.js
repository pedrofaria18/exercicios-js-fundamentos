/* Construa uma função para um sistema de notas de uma instituição que possui a seguinte política de classificação: Todo aluno recebe uma nota de 0 a 100. 
...
function notaAluno (nota) {
    ...
    if(notaCorrigida >= 40) {
        ...
        console.log(`O aluno foi reprovado com a nota: ${notaCorrigida}`)
    }
